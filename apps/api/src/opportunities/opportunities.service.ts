...
export class OpportunitiesService {
  constructor(@Inject(EXCHANGE_ADAPTER) private readonly exchangeAdapter: ExchangeAdapter) {}

  async list(options: ListOptions = {}) {
    const symbols = options.symbols?.length ? options.symbols : defaultSymbols;
